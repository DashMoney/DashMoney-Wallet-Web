    ...
    return (
      <>
        ...
        <div className="heading-shift">
          <p>
            This webpage is currently a testnet implementation used to showcase{" "}
            <b>Pay Groups</b> and facilate payments with{" "}
            <b>Full Featured: 2-Party Pay</b>. Moving this to a mainnet desktop
            application is the end goal.
          </p>
        </div>
