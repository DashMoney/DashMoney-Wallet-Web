...
class ConfirmJoinPayGroupModal extends React.Component {
  handleCloseClick = () => {
  ...
  render() {
    ...
    return (
      <>
        ...
        >
          <Modal.Header>
            <Modal.Title>Join Pay Group</Modal.Title>
            {closeButtonColor}
          </Modal.Header>
          <Modal.Body>
            <div
...
export default ConfirmJoinPayGroupModal;
